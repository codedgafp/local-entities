...
class admin_renderer extends \plugin_renderer_base {
    ...
    public function display() {
        ...
        $params->isentitymanager
            = \local_mentor_core\entity_api::count_managed_entities(null, false, null, true, is_siteadmin());

        // Get the right JS to use and call it.
        $js = entity_api::get_entity_javascript('local_entities/local_entities');
        $this->page->requires->js_call_amd($js, 'init', ['params' => $params]);
